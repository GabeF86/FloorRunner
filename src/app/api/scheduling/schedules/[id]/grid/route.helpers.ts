...
export const GRID_ASSIGNMENT_COLUMNS =
  'id, schedule_slot_id, provider_id, assignment_status, is_open_call, manually_overridden, validation_flags, highlight_color, notes, providers(id, first_name, last_name, short_display_name, initials, provider_type)';

export const GRID_ASSIGNMENT_COLUMNS_PRE42 =
  'id, schedule_slot_id, provider_id, assignment_status, is_open_call, manually_overridden, validation_flags, notes, providers(id, first_name, last_name, short_display_name, initials, provider_type)';
