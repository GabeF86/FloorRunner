...
export async function POST(
  ...
  // Merge into the call-gen result shape so the existing UI doesn't need to
  // change — numbers and arrays just grow to include day-shift work.
  ...
  result.unfilled.push(...dayResult.unfilled);
