// Thin injectable wrapper around the Anthropic SDK for the assistants.
...
//
// Relocated 2026-07-12 from scheduleAssistant/client.ts (a re-export shim
// remains there so existing import paths stay valid). Naming nit, deliberate:
// the '[scheduleAssistant]' log/error tags below are kept verbatim this round —
// renaming them would drift behavior the schedule suite may observe.
